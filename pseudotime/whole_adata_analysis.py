...
def whole_data_analysis(input_files, batch_labels, out_label, down_sample, hvgInfo, n_pcs, n_neighbors, batch_key):
	# # step0: Prepare data
	...
	# 	adata.uns['SubID_colors'] = random_hex_colors( n_colors=len( adata.uns['SubID_order']), random_seed=123456)
	...
	sc.pp.neighbors( high_adata, n_neighbors=n_neighbors, n_pcs=n_pcs, random_state=123456, use_rep="X_pca")
	# step7_a. calc umap
	sc.tl.umap( high_adata, random_state=123456)
	high_adata.write(out_label + '_high_adata.h5ad')
	print('UMAP calculation is finished!')
	ax = sc.pl.umap( high_adata, color=['Batch'], legend_fontsize=4, add_outline=False, size=5, legend_fontoutline=0.2, show=False);plt.savefig(f"{out_label}_umap_batch.png", format='png', bbox_inches='tight')
	ax = sc.pl.umap( high_adata, color=['SubID'], legend_fontsize=4, add_outline=False, size=5, legend_fontoutline=0.2, show=False);plt.savefig(f"{out_label}_umap_SubID.png", format='png', bbox_inches='tight')
	ax = sc.pl.umap( high_adata, color=['poolID'], legend_fontsize=4, add_outline=False, size=5, legend_fontoutline=0.2, show=False);plt.savefig(f"{out_label}_umap_pool.png", format='png', bbox_inches='tight')
	ax = sc.pl.umap( high_adata, color=['prep'], legend_fontsize=4, add_outline=False, size=5, legend_fontoutline=0.2, show=False);plt.savefig(f"{out_label}_umap_prep.png", format='png', bbox_inches='tight')
	...
	ax = sc.pl.umap( high_adata, color=['class'], legend_fontsize=4, add_outline=False, size=5, legend_fontoutline=0.2, show=False);plt.savefig(f"{out_label}_umap_class.png", format='png', bbox_inches='tight')
	ax = sc.pl.umap( high_adata, color=['subclass'], legend_fontsize=4, add_outline=False, size=5, legend_fontoutline=0.2, show=False);plt.savefig(f"{out_label}_umap_subclass.png", format='png', bbox_inches='tight')
	ax = sc.pl.umap( high_adata, color=['cell_type_uni'], legend_fontsize=4, add_outline=False, size=5, legend_fontoutline=0.2, show=False);plt.savefig(f"{out_label}_umap_cell_type_uni.png", format='png', bbox_inches='tight')
	ax = sc.pl.umap( high_adata, color=['subclass_uni'], legend_fontsize=4, add_outline=False, size=5, legend_fontoutline=0.2, show=False);plt.savefig(f"{out_label}_umap_subclass_uni.png", format='png', bbox_inches='tight')
	ax = sc.pl.umap( high_adata, color=['subtype_uni'], legend_fontsize=4, add_outline=False, size=5, legend_fontoutline=0.2, show=False);plt.savefig(f"{out_label}_umap_subtype_uni.png", format='png', bbox_inches='tight')

	# step8. UMAT
	# high_adata = sc.read(out_label + '_high_adata.h5ad')
	high_adata = umat( high_adata.uns['stage_order'], high_adata, pcaType='X_pca', n_neighbors=n_neighbors, n_pcs=int(n_pcs), rand=123456) #123, #12 #12345 #123456
	...
	ax = sc.pl.embedding( high_adata, basis='umat', color=['poolID'], legend_fontsize=4, add_outline=False, size=5, legend_fontoutline=0.2, show=False);plt.savefig(f"{out_label}_umat_pool.png", format='png', bbox_inches='tight')
	...
	if(batch_key != "no"):
		...
		sc.pp.neighbors( high_adata, n_neighbors=n_neighbors, n_pcs=int(n_pcs), random_state=123456, use_rep="X_pca_harmony")
		# step10_0_1. calc umap
		sc.tl.umap( high_adata, random_state=123456)
		high_adata.write(out_label + '_high_adata_rbe.h5ad')
		print('UMAP calculation is finished!')
		ax = sc.pl.umap( high_adata, color=['Batch'], legend_fontsize=4, add_outline=False, size=5, legend_fontoutline=0.2, show=False);plt.savefig(f"{out_label}_umap_rbe_batch.png", format='png', bbox_inches='tight')
		ax = sc.pl.umap( high_adata, color=['SubID'], legend_fontsize=4, add_outline=False, size=5, legend_fontoutline=0.2, show=False);plt.savefig(f"{out_label}_umap_rbe_SubID.png", format='png', bbox_inches='tight')
		ax = sc.pl.umap( high_adata, color=['poolID'], legend_fontsize=4, add_outline=False, size=5, legend_fontoutline=0.2, show=False);plt.savefig(f"{out_label}_umap_rbe_pool.png", format='png', bbox_inches='tight')
		ax = sc.pl.umap( high_adata, color=['prep'], legend_fontsize=4, add_outline=False, size=5, legend_fontoutline=0.2, show=False);plt.savefig(f"{out_label}_umap_rbe_prep.png", format='png', bbox_inches='tight')
		...
		ax = sc.pl.umap( high_adata, color=['class'], legend_fontsize=4, add_outline=False, size=5, legend_fontoutline=0.2, show=False);plt.savefig(f"{out_label}_umap_rbe_class.png", format='png', bbox_inches='tight')
		ax = sc.pl.umap( high_adata, color=['subclass'], legend_fontsize=4, add_outline=False, size=5, legend_fontoutline=0.2, show=False);plt.savefig(f"{out_label}_umap_rbe_subclass.png", format='png', bbox_inches='tight')
		ax = sc.pl.umap( high_adata, color=['cell_type_uni'], legend_fontsize=4, add_outline=False, size=5, legend_fontoutline=0.2, show=False);plt.savefig(f"{out_label}_umap_rbe_cell_type_uni.png", format='png', bbox_inches='tight')
		ax = sc.pl.umap( high_adata, color=['subclass_uni'], legend_fontsize=4, add_outline=False, size=5, legend_fontoutline=0.2, show=False);plt.savefig(f"{out_label}_umap_rbe_subclass_uni.png", format='png', bbox_inches='tight')
		ax = sc.pl.umap( high_adata, color=['subtype_uni'], legend_fontsize=4, add_outline=False, size=5, legend_fontoutline=0.2, show=False);plt.savefig(f"{out_label}_umap_rbe_subtype_uni.png", format='png', bbox_inches='tight')

		# step10_1. UMAT
		high_adata = umat( high_adata.uns['stage_order'], high_adata, pcaType='X_pca_harmony', n_neighbors=n_neighbors, n_pcs=n_pcs, rand=123456) #123, #12 #12345 #123456
		# swap order of x-axis to match umap, just makes visual comparison easier
		high_adata.obsm['X_umat'][:,0] = high_adata.obsm['X_umat'][:,0] * -1
		high_adata.write(out_label + '_high_adata_rbe.h5ad')
		print('UMAT calculation is finished!')
		ax = sc.pl.embedding( high_adata, basis='umat', color=['Batch'], legend_fontsize=4, add_outline=False, size=5, legend_fontoutline=0.2, show=False);plt.savefig(f"{out_label}_umat_rbe_Batch.png", format='png', bbox_inches='tight')
		ax = sc.pl.embedding( high_adata, basis='umat', color=['SubID'], legend_fontsize=4, add_outline=False, size=5, legend_fontoutline=0.2, show=False);plt.savefig(f"{out_label}_umat_rbe_SubID.png", format='png', bbox_inches='tight')
		ax = sc.pl.embedding( high_adata, basis='umat', color=['poolID'], legend_fontsize=4, add_outline=False, size=5, legend_fontoutline=0.2, show=False);plt.savefig(f"{out_label}_umat_rbe_pool.png", format='png', bbox_inches='tight')
		ax = sc.pl.embedding( high_adata, basis='umat', color=['prep'], legend_fontsize=4, add_outline=False, size=5, legend_fontoutline=0.2, show=False);plt.savefig(f"{out_label}_umat_rbe_prep.png", format='png', bbox_inches='tight')
		...
		ax = sc.pl.embedding( high_adata, basis='umat', color=['class'], legend_fontsize=4, add_outline=False, size=5, legend_fontoutline=0.2, show=False);plt.savefig(f"{out_label}_umat_rbe_class.png", format='png', bbox_inches='tight')
		ax = sc.pl.embedding( high_adata, basis='umat', color=['subclass'], legend_fontsize=4, add_outline=False, size=5, legend_fontoutline=0.2, show=False);plt.savefig(f"{out_label}_umat_rbe_subclass.png", format='png', bbox_inches='tight')
		ax = sc.pl.embedding( high_adata, basis='umat', color=['cell_type_uni'], legend_fontsize=4, add_outline=False, size=5, legend_fontoutline=0.2, show=False);plt.savefig(f"{out_label}_umat_rbe_cell_type_uni.png", format='png', bbox_inches='tight')
		ax = sc.pl.embedding( high_adata, basis='umat', color=['subclass_uni'], legend_fontsize=4, add_outline=False, size=5, legend_fontoutline=0.2, show=False);plt.savefig(f"{out_label}_umat_rbe_subclass_uni.png", format='png', bbox_inches='tight')
		ax = sc.pl.embedding( high_adata, basis='umat', color=['subtype_uni'], legend_fontsize=4, add_outline=False, size=5, legend_fontoutline=0.2, show=False);plt.savefig(f"{out_label}_umat_rbe_subtype_uni.png", format='png', bbox_inches='tight')

	# step11. Update full count matrix
	# set updated obsm to adata
	adata.obsm = high_adata.obsm
	adata.write(out_label + '_adata_updated.h5ad')
...
def main():
	...
	# parser.add_option('-a', '--age_orders', dest='age_orders', help='Age orders.')
	...
	print(options)
	whole_data_analysis(options.input_files, options.batch_labels, options.out_label, options.down_sample, options.hvgInfo, options.n_pcs, int(options.n_neighbors), options.batch_key)
